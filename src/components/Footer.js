...
export const Footer = () => {
  ...
  return (
    <>
    <div className="bg-black mx-auto h-auto pt-2 flex flex-wrap justify-between text-white border-t-2 border-gray-100">
      <div className="flex flex-col mx-10 my-5">
        <div className="text-xl md:mx-12 md:my-2 md:text-2xl text-orange-500 font-bold">About us </div>
        <p className="text-xs md:text-xl my-2 md:w-60 md:ml-12">Delicious meals delivered to your door. Order now! Eat well, effortlessly.</p>
        <div className="flex text-sm md:text-xl my-3 md:ml-10 md:my-4">
          <button className="bg-gray-800 text-xs md:text-xl p-2 rounded-lg mx-2">
      ...
      <div className="flex mx-5 text-xs md:text-xl lg:flex list-none md:mt-16">
      ...
      <div className="mx-10 text-sm md:text-xl sm:block mt-3 md:mt-12 md:mr-11">
        ...
        <button className="bg-white text-black py-2 px-6 rounded-lg mb-10 ml-2 hover:bg-orange-500" onClick={() => setEmail("")}> Submit</button>
      </div>
    </div>
